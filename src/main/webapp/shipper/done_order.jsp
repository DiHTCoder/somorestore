                                    ...
                                    <tr>
                                        ...
                                        <td >
                                          <c:choose>
                                            ...
                                            <c:when test="${order.status =='Giao hàng không thành công'}"><span class="badge bg-label-success me-1" style="color: red !important;">Giao hàng thất bại</span></c:when>
                                          </c:choose>
                                        </td>
                                    </tr>
                                </c:forEach>
