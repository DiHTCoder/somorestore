...
<%--															<c:if test="${not empty orderItemDAO.get(order.id)}">--%>
<%--																<c:forEach items="${orderItemDAO.get(order.id)}" var="item">--%>
<%--																	<tr>--%>
<%--																		<td><i class="fab fa-angular fa-lg text-danger"></i>--%>
<%--																			<strong>${item.product.name}</strong></td>--%>
<%--																		<td><strong>${item.product.price}</strong></td>--%>
<%--																		<td><strong class="ms-4">${item.quantity}</strong></td>--%>
