          ...
          <div class="card">
            ...
            <div class="table-responsive text-nowrap">
              <table class="table table-hover" style="table-layout: fixed;">
                ...
                <c:forEach items="${products}" var="product" varStatus="status">
                  <tr>
                    ...
                    <td>
                      <a href="<%request.getContextPath();%>/admin/edit-product?id=${product.id}">Sửa</a>
                    </td>
                    <td>
                      <form
              ...
              <div class="d-flex justify-content-center my-3">
                <a href="${pageContext.request.contextPath}/admin/add-product" type="submit" class="btn btn-primary">Thêm sản phẩm</a>
              </div>
            </div>
          </div>
        </div>
