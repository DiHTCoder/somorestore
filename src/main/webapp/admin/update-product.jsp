            ...
            <div class="col-xxl">
              <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                  <h5 class="mb-0">Update <strong>MaleFashion Hoodie</strong> Chi tiết</h5>
                ...
                <div class="card-body">
                  <form method="post" action="${pageContext.request.contextPath}/admin/${action}-product" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      <label class="col-sm-2 col-form-label" for="category-id">Danh mục</label>
                      <div class="col-sm-10">
...
<%--                          >--%>
  <input required type="text" name="image" class="form-control" id="name" placeholder="Name" value="${product.image}"/>
                      </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      <label class="col-sm-2 col-form-label" for="discount">Giảm giá</label>
                      <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                      <label class="col-sm-2 col-form-label" for="color">Màu</label>
                      <div class="col-sm-10">
                        <input required type="text" name ="color" class="form-control" id="color" placeholder="Color" value="${product.color}"/>
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label class="col-sm-2 col-form-label" for="brand">Thương hiệu</label>
                      <div class="col-sm-10">
