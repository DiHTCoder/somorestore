<%@ page import="com.onlinestorewepr.entity.Product"%>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center"
                             id="profile-head">
                            <img src="assets/img/instagram/instagram-1.jpg" alt="Admin"
            ...
            <div class="col-md-8">
                <div class="card mb-3 user-profile">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <a class="btn btn-info" target="" href="/update-profile">Sửa
                                    thông tin</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive table-borderless">
                                <table class="table">
                                    ...
                                    <tr class="cell-1">
                                        ...
                                        <td>${order.address}</td>
                                        <td><c:choose>
                                            <c:when test="${order.status =='Đã hủy đơn'}">
                                            ...
                                            <c:when
                                                    test="${order.status =='Đã xác nhận'}">
																<span class="badge bg-label-success me-1"
                                                                      style="color: sandybrown !important;">Đã giao cho đơn
																	vị vận chuyển</span>
                                            </c:when>
                                            <c:when
                                            ...
                                            <c:when test="${order.status =='Giao hàng không thành công'}">
																<span class="badge bg-label-success me-1"
                                                                      style="color: darkred !important;">Giao hàng không thành công</span>
                                            </c:when>
                                            <c:otherwise>
																<span class="badge bg-label-success me-1"
                                        ...
                                        <td>${order.total}</td>
                                        <td>${order.created}</td>
                                        <td><a href="./cancelOrder?orderId=${order.id}"
