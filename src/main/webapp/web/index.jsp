      ...
      <div class="row">
         <div class="col-lg-12">
            <ul class="filter__controls">
               <li class="active" data-filter="*">Top Sản phẩm bán chạy</li>
            </ul>
         </div>
      </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
               <div class="block product no-border z-depth-2-top z-depth-2--hover">
                  <div class="block-image">
                     <a href="#">
                        <img src="assets/img/shop/vans/vn0a4uuc1ae-4.png" class="img-center"></a>
         ...
         <div class="row product-item-discount">
            <div class="col-lg-3 col-md-4 col-sm-6">
               <div class="block product no-border z-depth-2-top z-depth-2--hover">
                  <div class="block-image">
                     <a href="#">
                        <img src="assets/img/shop/vans/vn0a4uuc1ae-4.png" class="img-center">
                     </a>
                     <span
