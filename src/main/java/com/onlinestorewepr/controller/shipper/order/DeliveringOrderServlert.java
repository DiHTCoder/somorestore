...
@WebServlet(name = "DeliveryOrder",value = {"/shipper/delivering-order","/delivering-order"})
public class DeliveringOrderServlert extends HttpServlet {
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        resp.setContentType("text/html;charset=UTF-8");
        OrderDAO dao = new OrderDAO();
        List<Order> orders = dao.getDeliveringOrders();
        ...
        req.getRequestDispatcher("/shipper/delivering.jsp").forward(req, resp);
    }
